...
<body>
    ...
    <header>
        <nav class="navbar">
            ...
            <a href="backend/restaurant_login.php"><button class="add-res" id="add-res">Restaurant</button></a>
    ...
    <section class="welcome-section">
        <div class="over-txt">
            ...
            <a href="backend/login.php"><button type="button" class="order-btn">Order Now</button></a>
        </div>
    </section>
